...
ns.currentSourceFile = "RetailPathsZoneNodes.lua"
        ...
        if db.activate.ZoneGeneral then
            ...
            if self.db.profile.showZoneEasternKingdom then
                ...
                if self.db.profile.showZonePaths then
                    ...
                    --nodes[23][54870622] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 95, mnID2 = 2537, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    ...
                    if ns.Addon.db.profile.activate.SwapButtons then -- Swap Button
                        nodes[23][54870622] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON2 .. " • " .. ns.EversongWoodsMidnight .. " (" .. EXPANSION_NAME11 ..")" .. "\n" .. KEY_BUTTON2 .. " • " .. ns.Ghostlands .. " (" .. EXPANSION_NAME1 .. ")", mnID = 2395, mnID2 = 95, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                        nodes[22][22855825] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_DAMAGE_MASTER .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_CAST_SUCCESS_MASTER, mnID = 18, mnID2 = 2070, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                        nodes[21][65540646] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_DAMAGE_MASTER .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_CAST_SUCCESS_MASTER, mnID = 18, mnID2 = 2070, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                        nodes[25][41950592] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_DAMAGE_MASTER .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_CAST_SUCCESS_MASTER, mnID = 18, mnID2 = 2070, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    else -- Original Button
                        nodes[23][54870622] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON1 .. " • " .. ns.EversongWoodsMidnight .. " (" .. EXPANSION_NAME11 ..")" .. "\n" .. KEY_BUTTON2 .. " • " .. ns.Ghostlands .. " (" .. EXPANSION_NAME1 .. ")", mnID = 2395, mnID2 = 95, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
            ...
            if self.db.profile.showZoneQuelThalas then
                ...
                if self.db.profile.showZonePaths then
                    nodes[2395][49139728] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 23, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2395][65424885] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2395][62448145] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2395][50483326] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 2393, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2395][48113326] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 2393, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2395][55063356] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 2393, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2395][50500402] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2424, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2437][19125433] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2395, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2437][25784799] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2395, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2437][27052291] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2395, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][05880910] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2395, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][05294732] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2395, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][41760917] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][20099054] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][51389103] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][70859101] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][80604735] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2536][77911851] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2437, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2424][52579650] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 2393, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2576][70295026] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2413, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2576][50761938] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2413, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2413][54545189] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2576, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2413][51834980] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2576, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                end
            end
